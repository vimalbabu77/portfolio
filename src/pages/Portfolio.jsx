...
const projects = {
    ...
    logos: {
        logos: [
            { title: 'Awawdeh Auto', img: `${import.meta.env.BASE_URL}Graphics/logo/awawdeh-auto-spare-parts.webp` },
            { title: 'E-SoftSat', img: `${import.meta.env.BASE_URL}Graphics/logo/esoftsat-01.webp` },
            { title: 'GI', img: `${import.meta.env.BASE_URL}Graphics/logo/GI.webp` },
            { title: 'GlobalTT SS', img: `${import.meta.env.BASE_URL}Graphics/logo/GLOBALTT_SS_LOGO_ART_new_logo_1.webp` },
            { title: 'GlobalTT', img: `${import.meta.env.BASE_URL}Graphics/logo/GLOBALTT.webp` },
            { title: 'HighEX', img: `${import.meta.env.BASE_URL}Graphics/logo/HighEX-_Logo_gif.gif` },
            { title: 'iFast', img: `${import.meta.env.BASE_URL}Graphics/logo/ifast-01.webp` },
            { title: 'IPSEOS', img: `${import.meta.env.BASE_URL}Graphics/logo/ipseos_new_selected_logo_26-11-2020-01.webp` },
            { title: 'Kowalu Shop', img: `${import.meta.env.BASE_URL}Graphics/logo/KOWALU_SHOP_LOGO_DESIGN-01.webp` },
            { title: 'Logo 3', img: `${import.meta.env.BASE_URL}Graphics/logo/LOGO_3-01.webp` },
            { title: 'GlobalTT Logo', img: `${import.meta.env.BASE_URL}Graphics/logo/logo_GTT_sa-56-01-01.webp` },
        ],
        graphics: [
            { title: 'Close User Group', img: `${import.meta.env.BASE_URL}Graphics/Graphics/CLOSE_USER_GROUP_NEW_ILLUSTRATION-01456_min.webp` },
            { title: 'Clouding Banner', img: `${import.meta.env.BASE_URL}Graphics/Graphics/CLOUDING_BANNER_NEW-01-01.webp` },
            { title: 'Differences', img: `${import.meta.env.BASE_URL}Graphics/Graphics/difference_C_7_Ku__KA_all_together_-01.webp` },
            { title: 'E-SoftSat Business Card', img: `${import.meta.env.BASE_URL}Graphics/Graphics/ESOFTSAT_BUSINESS_CARD_MOCKUP.webp` },
            { title: 'Experttrust BC', img: `${import.meta.env.BASE_URL}Graphics/Graphics/Experttrust_BC_model_2.webp` },
            { title: 'Fence & Antenna 1', img: `${import.meta.env.BASE_URL}Graphics/Graphics/fence_and_antenna_system-01.webp` },
            { title: 'Fence & Antenna 2', img: `${import.meta.env.BASE_URL}Graphics/Graphics/fence_and_antenna_system-02.webp` },
            { title: 'Fence & Antenna 3', img: `${import.meta.env.BASE_URL}Graphics/Graphics/fence_and_antenna_system-03.webp` },
            { title: 'GlobalTT Coverage', img: `${import.meta.env.BASE_URL}Graphics/Graphics/FULL_GLOBE_COVERAGE_PRINT_CMYK_VERSION-01.webp` },
            { title: 'GlobalTT Bandwidth', img: `${import.meta.env.BASE_URL}Graphics/Graphics/GLOBALTT_CUG_BANDWIDTH_DISTRIBUTION.webp` },
            { title: 'Wifi Diagram 2', img: `${import.meta.env.BASE_URL}Graphics/Graphics/Point_to_Point_Wifi_Connection_Diagram_2-01.webp` },
            { title: 'Wifi Diagram 3', img: `${import.meta.env.BASE_URL}Graphics/Graphics/Point_to_Point_Wifi_Connection_Diagram_2mining_3-01.webp` },
            { title: 'Polarization', img: `${import.meta.env.BASE_URL}Graphics/Graphics/polarization-all-in-one--design-2.webp` },
            { title: 'TV Broadcasting', img: `${import.meta.env.BASE_URL}Graphics/Graphics/TV_broadcasting_Diagram_Detaild-01.webp` },
            { title: 'VSAT Extender 225', img: `${import.meta.env.BASE_URL}Graphics/Graphics/VSAT_with_OUT_Point_to_point_wifi_extender_on_every_site_225.webp` },
            { title: 'VSAT Extender', img: `${import.meta.env.BASE_URL}Graphics/Graphics/VSAT_with_Point_to_point_wifi_extender_on_every_site.webp` },
            { title: 'VSAT No Extender', img: `${import.meta.env.BASE_URL}Graphics/Graphics/VSAT_with_Point_to_point_without_wifi_extender_on_every_site.webp` },
            { title: 'Wifi Camera', img: `${import.meta.env.BASE_URL}Graphics/Graphics/Wifi_Camera_with_solar_power_and_VSAT_connected_2-01.webp` },
            { title: 'Wifi Point to Point 2', img: `${import.meta.env.BASE_URL}Graphics/Graphics/WIFI_Point_to_Point_2-01.webp` },
            { title: 'Wifi Point to Point Demo', img: `${import.meta.env.BASE_URL}Graphics/Graphics/WIFI_Point_to_Point_demo-01.webp` },
        ]
    }
};
