...
const projects = {
    ...
    logos: {
        logos: [
            ...
            { title: 'GI', img: `${import.meta.env.BASE_URL}Graphics/logo/GI.jpg` },
            ...
            { title: 'iFast', img: `${import.meta.env.BASE_URL}Graphics/logo/ifast-01.jpg` },
            { title: 'IPSEOS', img: `${import.meta.env.BASE_URL}Graphics/logo/ipseos_new_selected_logo_26-11-2020-01.png` },
            { title: 'Kowalu Shop', img: `${import.meta.env.BASE_URL}Graphics/logo/KOWALU_SHOP_LOGO_DESIGN-01.png` },
            { title: 'Logo 3', img: `${import.meta.env.BASE_URL}Graphics/logo/LOGO_3-01.png` },
            { title: 'GlobalTT Logo', img: `${import.meta.env.BASE_URL}Graphics/logo/logo_GTT_sa-56-01-01.jpg` },
        ],
        graphics: [
            { title: 'Close User Group', img: `${import.meta.env.BASE_URL}Graphics/Graphics/CLOSE_USER_GROUP_NEW_ILLUSTRATION-01456_min.jpg` },
            { title: 'Clouding Banner', img: `${import.meta.env.BASE_URL}Graphics/Graphics/CLOUDING_BANNER_NEW-01-01.png` },
            { title: 'Differences', img: `${import.meta.env.BASE_URL}Graphics/Graphics/difference_C_7_Ku__KA_all_together_-01.png` },
            { title: 'E-SoftSat Business Card', img: `${import.meta.env.BASE_URL}Graphics/Graphics/ESOFTSAT_BUSINESS_CARD_MOCKUP.png` },
            { title: 'Experttrust BC', img: `${import.meta.env.BASE_URL}Graphics/Graphics/Experttrust_BC_model_2.jpg` },
            { title: 'Fence & Antenna 1', img: `${import.meta.env.BASE_URL}Graphics/Graphics/fence_and_antenna_system-01.jpg` },
            { title: 'Fence & Antenna 2', img: `${import.meta.env.BASE_URL}Graphics/Graphics/fence_and_antenna_system-02.jpg` },
            { title: 'Fence & Antenna 3', img: `${import.meta.env.BASE_URL}Graphics/Graphics/fence_and_antenna_system-03.jpg` },
            { title: 'GlobalTT Coverage', img: `${import.meta.env.BASE_URL}Graphics/Graphics/FULL_GLOBE_COVERAGE_PRINT_CMYK_VERSION-01.png` },
            { title: 'GlobalTT Bandwidth', img: `${import.meta.env.BASE_URL}Graphics/Graphics/GLOBALTT_CUG_BANDWIDTH_DISTRIBUTION.jpg` },
            { title: 'Wifi Diagram 2', img: `${import.meta.env.BASE_URL}Graphics/Graphics/Point_to_Point_Wifi_Connection_Diagram_2-01.png` },
            { title: 'Wifi Diagram 3', img: `${import.meta.env.BASE_URL}Graphics/Graphics/Point_to_Point_Wifi_Connection_Diagram_2mining_3-01.png` },
            { title: 'Polarization', img: `${import.meta.env.BASE_URL}Graphics/Graphics/polarization-all-in-one--design-2.jpg` },
            { title: 'TV Broadcasting', img: `${import.meta.env.BASE_URL}Graphics/Graphics/TV_broadcasting_Diagram_Detaild-01.jpg` },
            { title: 'VSAT Extender 225', img: `${import.meta.env.BASE_URL}Graphics/Graphics/VSAT_with_OUT_Point_to_point_wifi_extender_on_every_site_225.jpg` },
            { title: 'VSAT Extender', img: `${import.meta.env.BASE_URL}Graphics/Graphics/VSAT_with_Point_to_point_wifi_extender_on_every_site.jpg` },
            { title: 'VSAT No Extender', img: `${import.meta.env.BASE_URL}Graphics/Graphics/VSAT_with_Point_to_point_without_wifi_extender_on_every_site.jpg` },
            { title: 'Wifi Camera', img: `${import.meta.env.BASE_URL}Graphics/Graphics/Wifi_Camera_with_solar_power_and_VSAT_connected_2-01.jpg` },
            { title: 'Wifi Point to Point 2', img: `${import.meta.env.BASE_URL}Graphics/Graphics/WIFI_Point_to_Point_2-01.jpg` },
            { title: 'Wifi Point to Point Demo', img: `${import.meta.env.BASE_URL}Graphics/Graphics/WIFI_Point_to_Point_demo-01.jpg` },
        ]
    }
};
